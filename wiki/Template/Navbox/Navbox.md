...
-->{{#switch:{{{border|{{{1|}}}}}}|subgroup|child=</div>|none=|#default=<table class="navbox {{{bodyclass|}}}" cellspacing="0" <!--
 -->style="{{{bodystyle|}}};{{{style|}}}"><tr><td class="navbox-wrapper">}}<!--
...
-->{{#if:{{#switch:{{{navbar|}}}|plain|off=1}}<!--
 ...
 --><span class="{{{titleclass|}}}" style="font-size:{{#switch:{{{border|{{{1|}}}}}}|subgroup|child|none=100|#default=120}}%;"><!--
 -->{{{title}}}</span></th></tr>}}<!--
...
<noinclude>{{doc}}[[Category:Navigation templates]]</noinclude>