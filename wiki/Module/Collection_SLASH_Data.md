local all_collections = {
	...
	['Blaze Rod'] = {
		...
		[2] = {
			...
			reward = {
				{
					'{{Blue|Fire Aspect}} Exp Discount {{G|(-25%)}}',
					type = 'Custom',
					nolink = true,
	...
	['Cactus'] = {
		...
		[6] = {
			...
			reward = {
				{
					'{{Blue|Piercing}} Exp Discount {{G|(-25%)}}',
					type = 'Custom',
					nolink = true,
	...
	['Clay Ball'] = {
		...
		[3] = {
			...
			reward = {
				{
					'{{Blue|Respiration}} Exp Discount {{G|(-25%)}}',
					type = 'Custom',
					nolink = true,
	...
	['Coal'] = {
		...
		[2] = {
			...
			reward = {
				{
					'{{Blue|Smelting Touch}} Exp Discount {{G|(-25%)}}',
					type = 'Custom',
					nolink = true,
	...
	['Diamond'] = {
		...
		[2] = {
			...
			reward = {
				{
					'{{Blue|Execute}} Exp Discount {{G|(-25%)}}',
					type = 'Custom',
					nolink = true,
		...
		[5] = {
			...
			reward = {
				{
					'{{Blue|Critical}} Exp Discount {{G|(-25%)}}',
					type = 'Custom',
					nolink = true,
	...
	['Ender Pearl'] = {
		...
		[3] = {
			...
			reward = {
				{
					'{{Blue|Ender Slayer}} Exp Discount {{G|(-25%)}}',
					type = 'Custom',
					nolink = true,
	...
	['Feather'] = {
		...
		[1] = {
			...
			reward = {
				{
					'{{Blue|Projectile Protection}} Exp Discount {{G|(-25%)}}',
					type = 'Custom',
					nolink = true,
		...
		[2] = {
			...
			reward = {
				{
					'{{Blue|Feather Falling}} Exp Discount {{G|(-25%)}}',
					type = 'Custom',
					nolink = true,
		...
		[6] = {
			...
			reward = {
				{
					'{{Blue|Dragon Tracer}} Exp Discount {{G|(-25%)}}',
					type = 'Custom',
					nolink = true,
	...
	['Ghast Tear'] = {
		...
		[2] = {
			...
			reward = {
				{
					'{{Blue|Giant Killer}} Exp Discount {{G|(-25%)}}',
					type = 'Custom',
					nolink = true,
		...
		[4] = {
			...
			reward = {
				{
					'{{Blue|Vampirism}} Exp Discount {{G|(-25%)}}',
					type = 'Custom',
					nolink = true,
	...
	['Glacite'] = {
		[1] = {
			required = 100,
			reward = {
				{ 'Chilled Torch', type = 'Recipe', comingsoon = true },
			},
		},
		[2] = {
			required = 1000,
	...
	['Gold Ingot'] = {
		...
		[3] = {
			...
			reward = {
				{
					'{{Blue|Looting}} Exp Discount {{G|(-25%)}}',
					type = 'Custom',
					nolink = true,
		...
		[7] = {
			...
			reward = {
				{
					'{{Blue|Scavenger}} Exp Discount {{G|(-25%)}}',
					type = 'Custom',
					nolink = true,
		...
		[9] = {
			...
			reward = {
				{
					'{{Blue|Fortune}} Exp Discount {{G|(-25%)}}',
					type = 'Custom',
					nolink = true,
	...
	['Gravel'] = {
		...
		[4] = {
			...
			reward = {
				{
					'{{Blue|Sharpness}} Exp Discount {{G|(-25%)}}',
					type = 'Custom',
					nolink = true,
		...
		[6] = {
			...
			reward = {
				{
					'{{Blue|First Strike}} Exp Discount {{G|(-25%)}}',
					type = 'Custom',
					nolink = true,
	...
	['Gunpowder'] = {
		...
		[3] = {
			...
			reward = {
				{
					'{{Blue|Blast Protection}} Exp Discount {{G|(-25%)}}',
					type = 'Custom',
					nolink = true,
		...
		[5] = {
			...
			reward = {
				{
					'{{Blue|Thunderlord}} Exp Discount {{G|(-25%)}}',
					type = 'Custom',
					nolink = true,
	...
	['Iron Ingot'] = {
		...
		[3] = {
			...
			reward = {
				{
					'{{Blue|Protection}} Exp Discount {{G|(-25%)}}',
					type = 'Custom',
					nolink = true,
	...
	['Lapis Lazuli'] = {
		...
		[3] = {
			...
			reward = {
				...
				{
					'{{Blue|Experience}} Exp Discount {{G|(-25%)}}',
					type = 'Custom',
					nolink = true,
	...
	['Magma Cream'] = {
		...
		[2] = {
			...
			reward = {
				{
					'{{Blue|Fire Protection}} Exp Discount {{G|(-25%)}}',
					type = 'Custom',
					nolink = true,
	...
	['Melon Slice'] = {
		...
		[9] = {
			required = 250000,
			reward = {
				{ 'Melon Helmet', type = 'Recipe' },
				{ 'Melon Chestplate', type = 'Recipe' },
				{ 'Melon Leggings', type = 'Recipe' },
				{ 'Melon Boots', type = 'Recipe' },
			},
		},
	},
	['Mithril'] = {
	...
	['Raw Mutton'] = {
		...
		[6] = {
			...
			reward = {
				{
					'{{Blue|Rainbow}} Exp Discount {{G|(-25%)}}',
					type = 'Custom',
					nolink = true,
	...
	['Nether Wart'] = {
		...
		[5] = {
			required = 2500,
			reward = {
				{ 'Medium Potion Bag', slots = '9', type = 'Upgrade' },
			},
		},
		[6] = {
			required = 5000,
			reward = {
				{ 500, type = 'Alchemy Experience' },
			},
		},
		[7] = {
			required = 10000,
		...
		[8] = {
			required = 25000,
			reward = {
				{ 'Large Potion Bag', slots = '9', type = 'Upgrade' },
			},
		},
		[9] = {
			required = 50000,
		...
		[10] = {
			required = 75000,
			reward = {
				{ 'Giant Potion Bag', slots = '9', type = 'Upgrade' },
			},
		},
		[11] = {
			required = 100000,
		...
		[12] = {
			required = 250000,
			reward = {
				{ 'Massive Potion Bag', slots = '9', type = 'Upgrade' },
			},
		},
	},
	['Netherrack'] = {
	...
	['Obsidian'] = {
		...
		[2] = {
			...
			reward = {
				{
					'{{Blue|Lethality}} Exp Discount {{G|(-25%)}}',
					type = 'Custom',
					nolink = true,
	...
	['Prismarine Crystals'] = {
		...
		[4] = {
			...
			reward = {
				{
					'{{Blue|Aqua Affinity}} Exp Discount {{G|(-25%)}}',
					type = 'Custom',
					nolink = true,
		...
		[7] = {
			...
			reward = {
				{
					'{{Blue|Blessing}} Exp Discount {{G|(-25%)}}',
					type = 'Custom',
					nolink = true,
	...
	['Prismarine Shard'] = {
		...
		[1] = {
			...
			reward = {
				{
					'{{Blue|Impaling}} Exp Discount {{G|(-25%)}}',
					type = 'Custom',
					nolink = true,
	...
	['Pufferfish'] = {
		...
		[4] = {
			...
			reward = {
				{
					'{{Blue|Depth Strider}} Exp Discount {{G|(-25%)}}',
					type = 'Custom',
					nolink = true,
		...
		[6] = {
			...
			reward = {
				{
					'{{Blue|Spiked Hook}} Exp Discount {{G|(-25%)}}',
					type = 'Custom',
					nolink = true,
	...
	['Raw Cod'] = {
		...
		[3] = {
			required = 100,
			reward = {
				{ 'Small Fishing Bag', type = 'Upgrade' },
			},
		},
		[4] = {
			required = 250,
		...
		[7] = {
			required = 2500,
			reward = {
				{ 'Medium Fishing Bag', slots = '9', type = 'Upgrade' },
			},
		},
		[8] = {
			required = 15000,
			reward = {
				{ 'Enchanted Cooked Fish', type = 'Recipe' },
			},
		},
		[9] = {
			required = 30000,
			reward = {
				{ 'Large Fishing Bag', slots = '9', type = 'Upgrade' },
			},
		},
		[10] = {
			required = 45000,
			reward = {
				{ 'Giant Fishing Bag', slots = '9', type = 'Upgrade' },
			},
		},
		[11] = {
			required = 60000,
			reward = {
				{ 'Massive Fishing Bag', slots = '9', type = 'Upgrade' },
			},
		},
	},
	['Raw Porkchop'] = {
	...
	['Raw Rabbit'] = {
		...
		[7] = {
			...
			reward = {
				{
					'{{Blue|Luck of the Sea}} Exp Discount {{G|(-25%)}}',
					type = 'Custom',
					nolink = true,
		...
		[9] = {
			required = 50000,
			reward = {
				{ 'Rabbit Helmet', type = 'Recipe' },
				{ 'Rabbit Chestplate', type = 'Recipe' },
				{ 'Rabbit Leggings', type = 'Recipe' },
				{ 'Rabbit Boots', type = 'Recipe' },
			},
		},
	},
	['Raw Salmon'] = {
	...
	['Redstone Dust'] = {
		...
		[2] = {
			required = 250,
			reward = {
				{ 'Small Accessory Bag', type = 'Upgrade' },
			},
		},
		[3] = {
			required = 750,
			reward = {
				{
					'{{Blue|Efficiency}} Exp Discount {{G|(-25%)}}',
					type = 'Custom',
					nolink = true,
		...
		[6] = {
			required = 5000,
			reward = {
				{ 'Medium Accessory Bag', slots = '6', type = 'Upgrade' },
			},
		},
		[7] = {
			required = 10000,
		...
		[9] = {
			required = 50000,
			reward = {
				{ 'Large Accessory Bag', slots = '6', type = 'Upgrade' },
		...
		[10] = {
			required = 200000,
			reward = {
				{ 'Greater Accessory Bag', slots = '6', type = 'Upgrade' },
			},
		},
		[11] = {
			required = 400000,
			reward = {
				{ 'Giant Accessory Bag', slots = '6', type = 'Upgrade' },
		...
		[12] = {
			required = 600000,
			reward = {
				{ 'Massive Accessory Bag', slots = '6', type = 'Upgrade' },
			},
		},
		[13] = {
			required = 800000,
			reward = {
				{ 'Humongous Accessory Bag', slots = '6', type = 'Upgrade' },
		...
		[14] = {
			required = 1000000,
			reward = {
				{ 'Colossal Accessory Bag', slots = '6', type = 'Upgrade' },
		...
		[15] = {
			required = 1200000,
			reward = {
				{ 'Titanic Accessory Bag', slots = '6', type = 'Upgrade' },
			},
		},
		[16] = {
			required = 1400000,
			reward = {
				{ 'Preposterous Accessory Bag', slots = '6', type = 'Upgrade' },
			},
		},
	},
	['Rotten Flesh'] = {
	...
	['Slimeball'] = {
		...
		[3] = {
			...
			reward = {
				{
					'{{Blue|Knockback}} Exp Discount {{G|(-25%)}}',
					type = 'Custom',
					nolink = true,
	...
	['Spider Eye'] = {
		...
		[5] = {
			...
			reward = {
				{
					'{{Blue|Bane of Arthropods}} Exp Discount {{G|(-25%)}}',
					type = 'Custom',
					nolink = true,
		...
		[6] = {
			...
			reward = {
				{
					'{{Blue|Venomous}} Exp Discount {{G|(-25%)}}',
					type = 'Custom',
					nolink = true,
	...
	['String'] = {
		...
		[5] = {
			...
			reward = {
				{
					'{{Blue|Silk Touch}} Exp Discount {{G|(-25%)}}',
					type = 'Custom',
					nolink = true,
		...
		[6] = {
			...
			reward = {
				{
					'{{Blue|Infinite Quiver}} Exp Discount {{G|(-25%)}}',
					type = 'Custom',
					nolink = true,
					rewardstr = '&9Infinite Quiver &7Exp Discount &a(-25%)',
				},
				{ 'Large Quiver', slots = '9', type = 'Upgrade' },
			},
		},
		[7] = {
			required = 10000,
		...
		[9] = {
			required = 50000,
			reward = {
				{ 'Giant Quiver', slots = '9', type = 'Upgrade' },
			},
		},
	},
	['Sugar Cane'] = {
		...
		[6] = {
			required = 5000,
			reward = {
				{ 'Enchanted Bookshelf', type = 'Recipe' },
			},
		},
		[7] = {
			required = 10000,
	...
	['Tropical Fish'] = {
		...
		[5] = {
			required = 200,
			reward = {
				{ 'Medium Sack of Sacks', slots = '3', type = 'Upgrade' },
			},
		},
		[6] = {
			required = 400,
			reward = {
				{ 'Large Sack of Sacks', slots = '3', type = 'Upgrade' },
			},
		},
		[7] = {
			required = 800,
			reward = {
				...
				{ 'Greater Sack of Sacks', slots = '3', type = 'Upgrade' },
			},
		},
		[8] = {
			required = 1600,
			reward = {
				{ 'Giant Sack of Sacks', slots = '3', type = 'Upgrade' },
			},
		},
		[9] = {
			required = 4000,
			reward = {
				{ 'Massive Sack of Sacks', slots = '3', type = 'Upgrade' },
			},
		},
	},
	['Tungsten'] = {
		[1] = {
			required = 100,
			reward = {
				{ 'Chisel', type = 'Dwarven Forge Recipe' },
			},
		},
		[2] = {
			required = 1000,
		...
		[9] = {
			required = 500000,
			reward = {
				{ 'Enchanted Book (Metallurgy I)', type = 'Recipe', comingsoon = true },
			},
		},
	},
	['Umber'] = {
		[1] = {
			required = 100,
			reward = {
				{ 'Umber Dice', type = 'Dwarven Forge Recipe', comingsoon = true },
			},
		},
		[2] = {
			required = 1000,
		...
		[5] = {
			required = 25000,
			reward = {
				{ 'Excavator Potion', type = 'Recipe', comingsoon = true },
			},
		},
		[6] = {
			required = 50000,
